...
# Instance 1
n, L, p = 5, 5, 5 
C_mat = pd.read_csv("Data/LMP/LMP_C_5_5_5.csv", header=None).to_numpy()
d_mat = np.squeeze(pd.read_csv("Data/LMP/LMP_d_5_5_5.csv", header=None).to_numpy())  
obj_vals, times = [], []
i = 0 
cnt = 0
while i < 10*n: 
...
# Instance 2
n, L, p = 7, 7, 10 
C_mat = pd.read_csv("Data/LMP/LMP_C_7_7_10.csv", header=None).to_numpy()
d_mat = np.squeeze(pd.read_csv("Data/LMP/LMP_d_7_7_10.csv", header=None).to_numpy())  
obj_vals, times = [], []
i = 0 
cnt = 0
while i < 10*n: 
...
# Instance 3
n, L, p = 10, 10, 9 
C_mat = pd.read_csv("Data/LMP/LMP_C_10_10_9.csv", header=None).to_numpy()
d_mat = np.squeeze(pd.read_csv("Data/LMP/LMP_d_10_10_9.csv", header=None).to_numpy())  
obj_vals, times = [], []
i = 0 
cnt = 0
while i < 10*n: 
...
# Instance 4
n, L, p = 20, 20, 8 
C_mat = pd.read_csv("Data/LMP/LMP_C_20_20_8.csv", header=None).to_numpy()
d_mat = np.squeeze(pd.read_csv("Data/LMP/LMP_d_20_20_8.csv", header=None).to_numpy())  
obj_vals, times = [], []
i = 0 
cnt = 0
while i < 10*n: 
...
# Instance 5
n, L, p = 40, 40, 4 
C_mat = pd.read_csv("Data/LMP/LMP_C_40_40_4.csv", header=None).to_numpy()
d_mat = np.squeeze(pd.read_csv("Data/LMP/LMP_d_40_40_4.csv", header=None).to_numpy())  
obj_vals, times = [], []
i = 0 
cnt = 0
while i < 10*n: 
