...
# Instance 1
n = 10
C_mat = pd.read_csv("Data/LSE/LogSumExp_C_10_20.csv", header=None).to_numpy()
d_mat = np.squeeze(pd.read_csv("Data/LSE/LogSumExp_d_10_20.csv", header=None).to_numpy()) 
obj_vals, times = [], []
i = 0 
cnt = 0
while i < 10*n: 
...
# Instance 2
n = 40
C_mat = pd.read_csv("Data/LSE/LogSumExp_C_40_80.csv", header=None).to_numpy()
d_mat = np.squeeze(pd.read_csv("Data/LSE/LogSumExp_d_40_80.csv", header=None).to_numpy()) 
obj_vals, times = [], []
i = 0 
cnt = 0
while i < 10*n: 
...
# Instance 3
n = 10
C_mat = pd.read_csv("Data/LSE/LogSumExp_C_10_100.csv", header=None).to_numpy()
d_mat = np.squeeze(pd.read_csv("Data/LSE/LogSumExp_d_10_100.csv", header=None).to_numpy()) 
obj_vals, times = [], []
i = 0 
cnt = 0
while i < 10*n: 
...
# Instance 4
n = 20
C_mat = pd.read_csv("Data/LSE/LogSumExp_C_20_20.csv", header=None).to_numpy()
d_mat = np.squeeze(pd.read_csv("Data/LSE/LogSumExp_d_20_20.csv", header=None).to_numpy()) 
obj_vals, times = [], []
i = 0 
cnt = 0
while i < 10*n: 
...
# Instance 5
n = 50
C_mat = pd.read_csv("Data/LSE/LogSumExp_C_50_50.csv", header=None).to_numpy()
d_mat = np.squeeze(pd.read_csv("Data/LSE/LogSumExp_d_50_50.csv", header=None).to_numpy()) 
obj_vals, times = [], []
i = 0 
cnt = 0
while i < 10*n: 
